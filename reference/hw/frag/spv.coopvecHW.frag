...
void main()
{
    ...
    coopvecHW<float, 20u> _84;
    coopVecMatMulHW(_84, v7h, m8);
    coopvecHW<float, 20u> tempArg = _84;
    coopvecHW<float, 20u> v8 = tempArg;
    coopvecHW<int8_t, 100u> v9;
    coopmatHW<int8_t, 100u, 20u> m10;
    coopvecHW<int, 20u> _99;
    coopVecMatMulHW(_99, v9, m10);
    coopvecHW<int, 20u> tempArg_1 = _99;
    coopvecHW<int, 20u> v10 = tempArg_1;
    float16_t _108 = float16_t(int(100u));
    coopvecHW<float16_t, 2u> f162 = coopvecHW<float16_t, 2u>(_108);
    float16_t f16;
    ...
    coopvecHW<float, 20u> _291;
    coopVecMatMulAddHW(_291, v7h, m8, v8bias);
    coopvecHW<float, 20u> tempArg_2 = _291;
    v8 = tempArg_2;
    coopvecHW<int, 20u> v10bias;
    coopvecHW<int, 20u> _298;
    coopVecMatMulAddHW(_298, v9, m10, v10bias);
    coopvecHW<int, 20u> tempArg_3 = _298;
    v10 = tempArg_3;
    coopvecHW<float, 5u> _300 = v;
    coopvecHW<float, 5u> _301 = v;
    coopvecHW<float, 5u> _302 = _301 + _300;
    v = _302;
    f += _302[len];
}
